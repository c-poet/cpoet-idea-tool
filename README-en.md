...
- [ ]  🎉Patch generation is released as a separate plugin (JPatcher) as an important feature, while **CPoet Tool** retains the generation function
...
- [ ]  ✨**CPoot Tool** Configuration Panel Divided by Function (General, Text, Patch)
